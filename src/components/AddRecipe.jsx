      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="card">
            ...
            <div className="media">
              ...
              <div className="media-content">
                <p className="title is-5">
                  <div>
                    <label>Title</label>
                    <input className="label is-primary" type='text' value={name} onChange={e => setName(e.currentTarget.value)} />
                  </div>
                </p>
              </div>
            </div>
          ...
          <div className="content">
            <div className="card-content">
              Serves<br></br>
              <input value={serves} onChange={e => setServes(e.currentTarget.value)} />
            </div>
            <div className="card-content">
              Prep Time<br></br>
